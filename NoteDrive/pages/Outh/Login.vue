<template>
    ...
    <div  class="w-full p-6 m-auto  bg-white border-t border-S_Blue rounded-lg shadow-2xl shadow-blue/50 lg:max-w-md">
      <h1 class="text-3xl font-semibold text-center text-Orange">LOGIN</h1>
        ...
        <div class="mb-2.5">
          ...
          <NuxtLink to="/Outh/Reg"><a class="text-xs hover:text-Orange text-P_Blue hover:underline">New User?</a></NuxtLink>
        </form>
    </div>
</div>
